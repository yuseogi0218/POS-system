...
- 약 100만건의 거래 데이터에 대해서 100건 결과 데이터 집계 시, 4.907초 이내에 배치 프로그램 수행 완료

|Job|Input/Output data 개수|소요 시간|
|---|---|---|
|상품 판매 통계 데이터 생성<br>(1일 기준)|91,000 / 1,000|40.904초|
|상품 판매 통계 데이터 생성<br>(1주 기준)|631,000 / 1,000|36.735초|
|상품 판매 통계 데이터 생성<br>(1달 기준)|2,791,000 / 1,000|33.761초|
|정산 데이터 생성<br>(일정산)|30,100 / 100|2.267초|
|정산 데이터 생성<br>(월정산)|930,100 / 100|4.907초|
...
- 약 100만건의 거래 데이터에 대해서 100건 결과 데이터 집계 시, 43.984초 이내로 배치 프로그램 수행 완료
  - 기존 18분 이내로 수행되던 작업 → 내장 함수 제거와 인덱스 추가등의 쿼리 튜닝을 통해 43.984초로 단축 
    
    **(95.94% 성능 개선)**

|Job|Input/Output data 개수| 소요 시간      |
|---|---|------------|
|상품 판매 통계 데이터 생성<br>(1일 기준)|91,000 / 1,000| 27.963초    |
|상품 판매 통계 데이터 생성<br>(1주 기준)|631,000 / 1,000| 1분 5.448초  |
|상품 판매 통계 데이터 생성<br>(1달 기준)|2,791,000 / 1,000| 4분 17.106초 |
|정산 데이터 생성<br>(일정산)|30,100 / 100| 4.811초     |
|정산 데이터 생성<br>(월정산)|930,100 / 100| 43.984초    |
