# POS 정산 시스템 
### → [프로젝트 기획 링크](https://yuseogi0218.notion.site/POS-1615a0fb769580e39a1efa20872be862)
...
- 그렇기 때문에 서비스의 도메인(데이터베이스 스키마) 증가 및 데이터 누적으로 인해 서비스의 규모가 커지면, Ver 2가 더 적합한 방법
