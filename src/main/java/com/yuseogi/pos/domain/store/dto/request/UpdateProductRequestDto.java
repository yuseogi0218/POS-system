...
public record UpdateProductRequestDto(
    ...
    @NotNull(message = "상품 현재 재고는 필수 입력값입니다.")
    @Min(value = 0, message = "상품 현재 재고는 0 이상 10,000,000 이하의 정수 입니다.")
    @Max(value = 10000000, message = "상품 현재 재고는 0 이상 10,000,000 이하의 정수 입니다.")
    Integer stock,
