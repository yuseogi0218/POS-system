...
import com.yuseogi.pos.domain.trade.repository.implementation.OrderDetailJdbcTemplateRepositoryImpl;
...
public class OrderDetailJdbcTemplateRepositoryUnitTest {
    ...
    void saveAll() {
        ...
        verify(jdbcTemplate, times(1)).batchUpdate(
            eq("INSERT INTO order_detail (order_id, product_name, product_category, product_price, count, total_amount) VALUES (?, ?, ?, ?, ?, ?)"),
            eq(orderDetailList),
